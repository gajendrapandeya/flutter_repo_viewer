...
import 'package:repo_viewer/github/repos/starrred_repos/application/starred_repos_notifier.dart';
...
final starredReposNotifierProvider =
    StateNotifierProvider<StarredRepositoryNotifier, StarredReposState>(
  (ref) => StarredRepositoryNotifier(ref.watch(starredReposRepositoryProvider)),
);
